...
/**
 * This class adds an item to the cart
...
public class ProcessAddToCart implements HttpHandler {
  public void handle(HttpExchange he) throws IOException {
    ...
    // get ID number
    int productId = Integer.parseInt(parms.get("pid"));
    ...
    OrderItem newOrder = new OrderItem(0, productId, user_id, quantity);

    Boolean isAdded = OrderItemDAO.insertToCart(newOrder);
    ...
    if (isAdded) {
      out.write(
          "<html>" +
              ...
              "<h3 class=\"mb-3\">Item Add to Cart</h3>" +
              "<div class=\"row\">" +
              "<div class=\"container mt-3 p-4 \">" +
              "</div>" +
      ...
      out.write(
          "<html>" +
              ...
              +
              "<div class=\"container mt-3 p-4 \">" +
              "<h3 class=\"mb-3\">Could not Add item contact Admin</h3>" +
              "<div class=\"row\">" +
              "<div class=\"container mt-3 p-4 \">" +
              "</div>" +
              "<div class=\"col-lg-12 col-md-12 col-sm-12 \">" +
